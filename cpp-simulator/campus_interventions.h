...
void get_kappa_custom_modular(std::vector<agent>& nodes, const std::vector<Interaction_Space>& i_spaces, const int cur_time, const intervention_params intv_params, int day);

void get_kappa_file_read(std::vector<agent>& nodes, const std::vector<Interaction_Space>& i_spaces, const std::vector<intervention_params>& intv_params_vector, int cur_time, int day);
