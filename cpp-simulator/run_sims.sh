...
num_fatalities="/Users/Minhaas/CODING/iisc/campus-simulator/markov_simuls/staticInst/data/campus_outputs/num_fatalities.csv"
num_recovered="/Users/Minhaas/CODING/iisc/campus-simulator/markov_simuls/staticInst/data/campus_outputs/num_recovered.csv"
...
for sim in {1..10}
do 
./drive_simulator --input_directory /Users/Minhaas/CODING/iisc/campus-simulator/markov_simuls/staticInst/data/campus_data --output_directory /Users/Minhaas/CODING/iisc/campus-simulator/markov_simuls/staticInst/data/campus_outputs --SEED_FIXED_NUMBER  --INIT_FIXED_NUMBER_INFECTED $SEED_VALUE
echo 
echo "----------------------------------------$sim RUN DONE------------------------------------------"
