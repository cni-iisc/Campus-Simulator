...
function run_simulation(SIM_COUNT) {
    ...
    const interval = setInterval(function () {
        ...
        if (time_step >= NUM_TIMESTEPS || SIMULATION_STOP) {
            ...
            link.setAttribute("download", "my_data_"+SIM_COUNT.toString()+".csv");
            ...
            link.setAttribute("href", encodedUri);
            link.setAttribute("download", "my_data_all_together_"+SIM_COUNT.toString()+".csv");
            document.body.appendChild(link); // Required for FF
...
//	COMPLIANCE_PROBABILITY = document.getElementById("compliance").value;
    ...
    SIM_COUNT = document.getElementById("simNum").value;
...
function set_default_values_html() {
    ...
    document.getElementById("simNum").value = SIM_NUM;
