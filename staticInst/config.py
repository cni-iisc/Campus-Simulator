...
config_json = []
def configCreate(min_group_size, max_group_size, beta_scaling_factor, avg_num_assns, periodicity, minimum_hostel_time, kappa_class_case_isolation, kappa_hostel_case_isolation, kappa_mess_case_isolation, kappa_cafe_case_isolation, kappa_smaller_networks_case_isolation, kappa_class_lockdown, kappa_hostel_lockdown, kappa_mess_lockdown, kappa_cafe_lockdown, kappa_smaller_networks_lockdown):
    config = {}
...
if __name__ == "__main__":
    ...
    config = configCreate(min_group_size, max_group_size, beta_scaling_factor, avg_num_assns, periodicity, min_hostel_time, kappa_class_case_isolation, kappa_hostel_case_isolation, kappa_mess_case_isolation, kappa_cafe_case_isolation, kappa_smaller_networks_case_isolation, kappa_class_lockdown, kappa_hostel_lockdown, kappa_mess_lockdown, kappa_cafe_lockdown, kappa_smaller_networks_lockdown)
