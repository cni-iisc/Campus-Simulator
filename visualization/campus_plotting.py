...
plt.savefig(plots_dir + '/cumulative_cases_all_sn_config_80321_avg_time_cafe_kappa.png')
...
plt.xlabel('Timesteps', fontsize=14)
plt.ylabel('Cases', fontsize = 14)
plt.savefig(plots_dir + '/daily_cases_all_sn_config_80321_avg_time_cafe_kappa.png')